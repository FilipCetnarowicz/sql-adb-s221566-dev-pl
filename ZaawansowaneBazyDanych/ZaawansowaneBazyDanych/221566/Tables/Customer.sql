...
WITH (SYSTEM_VERSIONING = ON (HISTORY_TABLE=[221566].[CustomerHistory], DATA_CONSISTENCY_CHECK=ON));


GO
CREATE NONCLUSTERED INDEX [IX_Customer_EmailAddress]
    ON [221566].[Customer]([EmailAddress] ASC);
